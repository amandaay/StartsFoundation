          ...
          <div className="row">
            <div className="col objective-box">
              ...
              <span className="core-values-span">
                <p className="core-p">
                  <span className="core-title">EMPOWERMENT</span>
                  <br />
                  The foundation focuses on empowering people and enabling their
                  self-determination to live life in a responsible way.
                  Corroborating confidence and helping people overcome the sense
                  of powerlessness is the core value of Starts foundation.
                  <br />
                  <br />
                  ...
                  <br />
                  It has always maintained a transparent relationship with the
                  development partners, community group, government, and people
                  associated all the while fostering the bond in a significant
                  way. Standing accountable to all the terms, it has paved its
                  way into society as one of the emerging social organizations
                  which works to thrive with dignity.
                  <br />
                  <br />
                  <span className="core-title">
                    ENSURING PRODUCTIVITY THROUGH RESOURCE UTILIZATION
                  </span>
                  <br />
                  Starts foundation has worked its way through enumerous hurdles
                  abiding by the vow of sustenance. It has helped people with
                  provision of resources aiding them with physical
                  infrastructures and skillful programmes ensuring their
              ...
              <span className="obj-p">
                <ul>
                  ...
                  <li>
                    ...
                    necessary access to hygienic menstrual products
                  </li>
                  <li>
                    To conduct awareness programs about reproductive health
                  </li>
                  <li>
