  ...
  return (
    <section className="proj-top-container">
      ...
      <div className="row proj-top-row">
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 proj-top-left">
          <ProjectPagination
            currentPage={page}
            totalPages={pageSize}
        ...
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 proj-top-right">
