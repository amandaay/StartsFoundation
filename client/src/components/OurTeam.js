            ...
            <div className="d-flex justify-content-center">
                <div className="row gx-5 mt-4 p-4 bg-white w-75">
                    <div className="col-5 d-flex justify-content-center">
                        <PersonalInfo image="../images/about/about-2.jpg" css="" imageCss="memberLeftPic"></PersonalInfo>
                    </div>

                    <div className="col-7">
                        <div className="row g-5">
                            <PersonalInfo image="../images/about/about-2.jpg" css="col-6" imageCss="memberRightPic"></PersonalInfo>
                            <PersonalInfo image="../images/about/about-2.jpg" css="col-6" imageCss="memberRightPic"></PersonalInfo>
                            <PersonalInfo image="../images/about/about-2.jpg" css="col-6" imageCss="memberRightPic"></PersonalInfo>
                            <PersonalInfo image="../images/about/about-2.jpg" css="col-6" imageCss="memberRightPic"></PersonalInfo>
                        </div>
